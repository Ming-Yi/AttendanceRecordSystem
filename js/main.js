		...
		if(document.cookie.length>0){
			...
			for(var index in theCookies){
				if(theCookies[index].indexOf("jsession=")!=-1){
					jsession = theCookies[index].substring(theCookies[index].indexOf("=")+1,theCookies[index].length);
				}else if(theCookies[index].indexOf("schnos=")!=-1){
					var schnos = theCookies[index].substring(theCookies[index].indexOf("=")+1,theCookies[index].length).split(",");
					...
					account = theCookies[index].substring(theCookies[index].indexOf("=")+1,theCookies[index].length);
				}
			}
		}
		else{
